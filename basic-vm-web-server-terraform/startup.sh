...
<html>
<head>
  <title>6.5 Circle of Heel</title>
  <meta charset="UTF-8">
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://www.wallpaperflare.com/static/710/75/707/dark-souls-3-armor-warrior-fire-wallpaper.jpg');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://giphy.com/embed/5JxyyZjC7zidL3aj6C"
              width="500"
              height="270"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      <h1>Jscales Compute Instance Information</h1>
      <h3></h3>
